...
If no topology transition is observed, the monitor phase fails before the Widget probe and the sequence cursor does not advance. This turns monitor recovery into observed, durable evidence rather than operator assertion.
