# MiaoDesk Glass UI Design Language
...
The reference image is not a one-off mock. It defines the shared visual family for future MiaoDesk lightweight UI.

## 2. Product character

MiaoDesk UI should feel:
...
- header is quiet: `妙喵 AI`, optional status and compact menu;
...
- future notification/toast surfaces owned by MiaoDesk.
...
A new MiaoDesk surface should not be called visually complete merely because it compiles or approximately matches these numbers.
