...
# RuntimeBundle owns only the pinned executable runtimes (Node / Pi / Harness / Goz).
# Wallpaper assets are product content and are staged by the package/update layer from
# assets/wallpapers. Keeping those responsibilities separate also allows runtime-only sparse
# checkouts to be materialized without requiring an unrelated legacy BuiltinWallpapers.mdpack.
